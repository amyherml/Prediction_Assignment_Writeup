...
trainingset <- read.csv("~/Machine_Learning/Prediction_Assignment_Writeup/pml-training.csv", na.strings=c("NA","#DIV/0!", ""))

# Loading the testing data set 
testingset <- read.csv("~/Machine_Learning/Prediction_Assignment_Writeup/pml-testing.csv", na.strings=c("NA","#DIV/0!", ""))
